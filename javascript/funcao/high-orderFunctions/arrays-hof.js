...
// Sort
// sort: ordena os elementos de um array a partir de comparações entre duplas de elementos ordem crescente
...
// para não modificar o array original
const novoArray = personagens.slice().sort(function (a, b) {
  return a.nivel - b.nivel
})

// forEach
// forEach: permite executar uma função para cada elemento de um array
